...
use app\models\reporte\ViewGastos;
use Yii;
 ...
 */
class ReporteGastosController extends \app\controllers\AppController
{
    /**
    ...
    public function actionGastoJsonBtt(){
        return ViewGastos::getJsonBtt(Yii::$app->request->get());
    }
}
