...
<div class="almacenes-almacen-form">

    <?php $form = ActiveForm::begin(['id' => 'form-almacen','options' => ['enctype' => 'multipart/form-data'] ]) ?>

    <div class="form-group">
        <?= Html::submitButton($model->isNewRecord ? 'Crear almacen' : 'Guardar cambios', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
        ...
        <div class="col-lg-7">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-lg-6">
                            <?= $form->field($model, 'nombre')->textInput(['maxlength' => true])->label("Nombre de bodega") ?>
