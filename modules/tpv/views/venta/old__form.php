                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <?php /* ?><td class="text-center">SALDAR TOTAL</td>*/?>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?= Html::input('number', 'efectivo', EsysSetting::getCorteCaja(), ['class' => "form-control text-center", "id" => "inputTotalRetiro",  "style" => "font-size: 32px;"]) ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <?= Html::label('CONCEPTO', 'gasto') ?>
                                <?= Html::textArea('concepto',"",['class' => "form-control", 'id'=>'concepto', 'rows' => 2, 'readonly' => false]); ?>
...
<script>
        ...
        $.each(notaCreditoArray,function(key, credito){
            content_html += "<tr>"+
               ...
               //"<td class='text-center'><input type='checkbox'  onchange = 'cobro_credito_function(this,"+ credito.id +", "+ parseFloat(credito.monto).toFixed(2) +",true)'></td>"+
                "<td class='text-center'><input type='number' class='form-control text-center' value='"+ credito.total_pago +"'  disabled/></td"+
            "</tr>";
    ...
    var add_folio = function(){
        ...
        if ($inputFolioAdd.val()) {
            $.get("<?= Url::to(['get-pre-venta'])?>",{ id :  $inputFolioAdd.val() },function($response){
                if ($response.code == 202) {
                    PREVENTA_ID = $response.venta.id;
