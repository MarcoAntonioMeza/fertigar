        ...
        <div class="ibox">
            <div class="ibox-content">
                <form action="" method="POST" id="form-asientos-contables">
                    <button type="button" class="btn btn-success" style="padding: 10px 15px; margin-bottom:30px;" onclick="GuardarAsientos()"> GUARDAR CONFIGURACIÓN </button></button><br> <br>
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-6">
                            <p style="font-size:14px">CONCEPTO</p>
                            <?= Html::input("text", 'concepto', false, [ "class" => "form-control", "style" => "font-size:24px;font-weight:700" ]) ?>
                        </div>
                    </div>


                    <div id="listas" style=" padding-top:25px;">
                        <div class="row">
                            <div class="col-sm-3">
                                <p style="font-size:14px; font-weight:700; color:#000">CUENTA</p>
                                <input type="text" hidden id="id_cuenta_0" name="id_cuenta[0]">
                                <input  type="text" class="form-control" placeholder="Escribe aquí..." id="cuenta_0" name="cuentas[0]" autocomplete="off" list="search_list" onkeyup="autocomp(this.value,0)" oninput="get_id_cuenta(0)">
                                    <datalist id="search_list" ></datalist>
                            </div>

                            <div class="col-sm-3">
                                <p style="font-size:14px; font-weight:700; color:#000">CARGO $$</p>
                                <input type="number" class="form-control" placeholder="$" id="cargo_0" name="cargos[0]" value="0" min="0" max="100" required>
                            </div>
                            <div class="col-sm-3">
                                <p style="font-size:14px; font-weight:700; color:#000">ABONO $$</p>
                                <input type="number" class="form-control" placeholder="$" id="abono_0" name="abonos[0]" value="0" min="0" max="100" required>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-sm-3">
                                ...
                                <input type="text" class="form-control" placeholder="Escribe aquí..." id="cuenta_1" name="cuentas[1]"  autocomplete="off" list="search_list" onkeyup="autocomp(this.value,1)" oninput="get_id_cuenta(1)">
            ...
            if (x < campos_max) {
                    ...
                    <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <a href="#" class="remover_campo  btn btn-danger" style="margin-left:1095px; margin-top:-55px;">Eliminar cuenta <i class="fa fa-trash" style="margin-left:5px;"></i></a>\
                            </div>`);
                    x++;
                    count++;
            }
...
<script type="text/javascript">
    ...
    function GuardarAsientos()
    {
        ...
        $.ajax({
                url: VAR_URL_PATH + "/contabilidad/polizas/asientos-contables",
                data:info,
                type:'post',
                processData: false,
                contentType: false,
                success: function (response) {
                    if(response.code==202){
                        ...
                        toastr.success("SE REGISTRO CORRECTAMENTE LA OPERACION", "REGISTRO POLIZA");
                        window.location.href= VAR_URL_PATH+ '/contabilidad/polizas/index';
                        ...
                        toastr.warning("VERIFICA TU INFORMACIÓN, INTENTA NUEVAMENTE", "REGISTRO POLIZA");
                    }
                },
            });
