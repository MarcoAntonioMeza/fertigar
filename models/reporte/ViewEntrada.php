...
/**
 * This is the model class for table "view_entrada".
 *
 * @property int $id ID
 * @property int $folio_operacion ID
 * @property int|null $compra_id Compra ID
 * @property int|null $is_especial Is Especial
 ...
 */
class ViewEntrada extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
