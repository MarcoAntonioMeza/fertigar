...
class Venta extends \yii\db\ActiveRecord
{
    ...
    public static $ventaList = [
        self::VENTA_ESPECIAL    => 'REMISION ESPECIAL',
        self::VENTA_GENERAL     => 'REMISION NORMAL',
    ];

    public static $tipoList = [
        self::TIPO_GENERAL  => 'REMISION PUBLICO GENERAL',
        self::TIPO_MENUDEO  => 'REMISION MENUDEO',
        self::TIPO_MAYOREO  => 'REMISION MAYOREO',
    ...
    public static function applyFactura($venta_id)
    {
        return  (new Query())
            ->from('factura')
